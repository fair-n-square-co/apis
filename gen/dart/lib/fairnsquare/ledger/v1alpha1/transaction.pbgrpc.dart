...
@$pb.GrpcServiceName('fairnsquare.ledger.v1alpha1.TransactionService')
class TransactionServiceClient extends $grpc.Client {
  static final _$createTransaction = $grpc.ClientMethod<
      ...
      '/fairnsquare.ledger.v1alpha1.TransactionService/CreateTransaction',
  ...
  static final _$listTransactions = $grpc.ClientMethod<
      ...
      '/fairnsquare.ledger.v1alpha1.TransactionService/ListTransactions',
...
abstract class TransactionServiceBase extends $grpc.Service {
  $core.String get $name => 'fairnsquare.ledger.v1alpha1.TransactionService';
