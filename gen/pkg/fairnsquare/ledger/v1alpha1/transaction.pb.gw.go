...
func RegisterTransactionServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TransactionServiceServer) error {
	...
	mux.Handle("POST", pattern_TransactionService_CreateTransaction_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/fairnsquare.ledger.v1alpha1.TransactionService/CreateTransaction", runtime.WithHTTPPathPattern("/fairnsquare.ledger.v1alpha1.TransactionService/CreateTransaction"))
		if err != nil {
	...
	mux.Handle("POST", pattern_TransactionService_ListTransactions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/fairnsquare.ledger.v1alpha1.TransactionService/ListTransactions", runtime.WithHTTPPathPattern("/fairnsquare.ledger.v1alpha1.TransactionService/ListTransactions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterTransactionServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TransactionServiceClient) error {
	...
	mux.Handle("POST", pattern_TransactionService_CreateTransaction_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/fairnsquare.ledger.v1alpha1.TransactionService/CreateTransaction", runtime.WithHTTPPathPattern("/fairnsquare.ledger.v1alpha1.TransactionService/CreateTransaction"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_TransactionService_ListTransactions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/fairnsquare.ledger.v1alpha1.TransactionService/ListTransactions", runtime.WithHTTPPathPattern("/fairnsquare.ledger.v1alpha1.TransactionService/ListTransactions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_TransactionService_CreateTransaction_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"fairnsquare.ledger.v1alpha1.TransactionService", "CreateTransaction"}, ""))

	pattern_TransactionService_ListTransactions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"fairnsquare.ledger.v1alpha1.TransactionService", "ListTransactions"}, ""))
)
